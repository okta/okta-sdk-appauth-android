...
import static com.okta.openid.appauth.AdditionalParamsProcessor.builtInParams;
import static com.okta.openid.appauth.AdditionalParamsProcessor.checkAdditionalParams;
import static com.okta.openid.appauth.Preconditions.checkArgument;
import static com.okta.openid.appauth.Preconditions.checkNotEmpty;
import static com.okta.openid.appauth.Preconditions.checkNotNull;
import static com.okta.openid.appauth.Preconditions.checkNullOrNotEmpty;
/**
...
public class AuthorizationRequest extends AuthorizationManagementRequest {
    ...
    public static final class Builder {
         ...
         * specified prompt values.
         *
         * @param promptValues - promptValues
         * @return builder
         *
         * @see Prompt
         * @see "OpenID Connect Core 1.0, Section 3.1.2.1
         ...
         *
         * @param codeVerifier - codeVerifier
         * @param codeVerifierChallenge - codeVerifierChallenge
         * @param codeVerifierChallengeMethod - codeVerifierChallengeMethod
         * @return builder
         *
         * @see "Proof Key for Code Exchange by OAuth Public Clients (RFC 7636), Section 4.3
         * <https://tools.ietf.org/html/rfc7636#section-4.3>"
