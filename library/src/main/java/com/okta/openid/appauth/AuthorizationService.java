...
import com.okta.openid.appauth.AuthorizationException.TokenRequestErrors;
...
public class AuthorizationService {
    ...
    public interface TokenResponseCallback {
         ...
         * <p/>
         * Exactly one of `response` or `ex` will be non-null. If `response` is `null`,
         * a failure occurred during the request. This can happen if a bad URI was provided,
         * no connection to the server could be established, or the response JSON
         * was incomplete or incorrectly formatted.
         *
