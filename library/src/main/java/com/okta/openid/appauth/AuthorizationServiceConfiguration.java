...
public class AuthorizationServiceConfiguration {
    ...
    public static AuthorizationServiceConfiguration fromJson(@NonNull JSONObject json)
        ...
        if (json.has(KEY_DISCOVERY_DOC)) {
            ...
            Preconditions.checkArgument(json.has(KEY_AUTHORIZATION_ENDPOINT),
                    "missing authorizationEndpoint");
            Preconditions.checkArgument(json.has(KEY_TOKEN_ENDPOINT),
    ...
    public static void fetchFromUrl(
        ...
        Preconditions.checkNotNull(openIdConnectDiscoveryUri,
                "openIDConnectDiscoveryUri cannot be null");
