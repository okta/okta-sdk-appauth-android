...
public class TokenResponse {
    ...
    public static final class Builder {
        ...
        public Builder fromResponseJson(@NonNull JSONObject json) throws JSONException {
            ...
            setAdditionalParameters(AdditionalParamsProcessor.extractAdditionalParams(json,
                    BUILT_IN_PARAMS));
        ...
        public Builder setRequest(@NonNull TokenRequest request) {
            mRequest = Preconditions.checkNotNull(request, "request cannot be null");
            return this;
        }
        ...
        public Builder setTokenType(@Nullable String tokenType) {
            mTokenType = Preconditions.checkNullOrNotEmpty(tokenType,
                    "token type must not be empty if defined");
            return this;
        }
        ...
        public Builder setAccessToken(@Nullable String accessToken) {
            mAccessToken = Preconditions.checkNullOrNotEmpty(accessToken,
        ...
        public Builder setIdToken(@Nullable String idToken) {
            mIdToken = Preconditions.checkNullOrNotEmpty(idToken,
                    "id token must not be empty if defined");
            return this;
        }
        ...
        public Builder setRefreshToken(@Nullable String refreshToken) {
            mRefreshToken = Preconditions.checkNullOrNotEmpty(refreshToken,
        ...
        public Builder setAdditionalParameters(@Nullable Map<String, String> additionalParameters) {
            mAdditionalParameters = AdditionalParamsProcessor
