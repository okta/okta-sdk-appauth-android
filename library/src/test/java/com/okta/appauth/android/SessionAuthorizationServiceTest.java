...
public class SessionAuthorizationServiceTest {
    AuthStateManager mAuthStateManager;
    AuthorizationService mAuthService;

    private SessionAuthorizationService sessionAuthorizationService;
    ...
    public void setUp() throws Exception {
        ...
        sessionAuthorizationService = new SessionAuthorizationService(mAuthStateManager, mAuthService);
    ...
    public void testValidCredentialsPerformAuthorizationRequest() throws IOException {
        ...
        sessionAuthorizationService.performAuthorizationRequest(request, VALID_SESSION, listener);
    ...
    public void testInValidCredentialsPerformAuthorizationRequest() {
        ...
        sessionAuthorizationService.performAuthorizationRequest(request, null, listener);
    ...
    public void testNullListenerPerformAuthorizationRequest() {
        sessionAuthorizationService.performAuthorizationRequest(request, VALID_SESSION, null);
        sessionAuthorizationService.performAuthorizationRequest(request, null, null);
    }
